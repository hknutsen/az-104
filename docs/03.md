...
-Azure Files
  ...
  - Azure Files provides shared access to files across multiple VMs
  - Any number of Azure virtual machines or roles can mount and access an Azure file share simultaneously
  - Applications that run in Azure VMs or cloud services can mount an Azure file share to access file data
