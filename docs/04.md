...
- Each plan defines three settings:
    1. Region for the App Service plan
    2. Number of VM instances to allocate for the plan
    3. Size of VM instances, small, medium or large
- Pricing tiers:
  - Free and Shared
    ...
    - Application can't scale out	
  - Basic
    - Designed for lower traffic applications
    - No need for auto scale and traffic management features
    - Manual scale out to 3 instances
    - 10 GB disk space
    - Pricing is based on the size and number of instances you run
    - Basic service plan with Linux runtime environments supports Web App for Containers
  ...
  - Standard
    ...
    - Supports autoscale that can automatically adjust the number of virtual machines instances to match your traffic needs
    - 50 GB disk space
    - Pricing is based on the size and number of instances you run
    - Standard service plan with linux environments supports Web App Containers
    - Usage: Production
  - Premium
    - Designed for highest performance
    - premium plan compared to standard
	- premiumv2 offers: 
	- Dv2-series virtual machines with faster processirs 
	- SSD storage 
  ...
  - Isolated
    ...
    - Isolated plan offers the same plan as premium
    - 1 TB disk space
...
- Scaling
  ...
  - Scaling up gives you extra features:
	...
	- Stagin slots
	- Autoscaling
  - Scale-out method increase the number of virtual machine instances that run your application
  - Scale out to as many as 30 instances, depending on your App Service plan pricing tier
  ...
  - App Service plan can be scaked up and down at any time, simply change the pricing tier of your current plan
  ...
  - Autoscale
    ...
    - Autoscale is based in predefined rules and schedules
	...
	- Time-based rules allow you to scale when you see time patterns in your load and want to scale before a possible load increase or decrease occurs
